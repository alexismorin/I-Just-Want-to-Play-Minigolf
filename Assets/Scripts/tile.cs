...
public class tile : MonoBehaviour {
    ...
    public void BuildStep () {
        ...
        for (int i = 0; i < orderList.Length; i++) {
            ...
            if (i == orderList[0]) {
                if (Physics.Raycast (tileUp, transform.TransformDirection (Vector3.down), out upHit, Mathf.Infinity)) {
            ...
            if (i == orderList[1]) {
                if (Physics.Raycast (tileDown, transform.TransformDirection (Vector3.down), out downHit, Mathf.Infinity)) {
            ...
            if (i == orderList[2]) {
                if (Physics.Raycast (tileLeft, transform.TransformDirection (Vector3.down), out leftHit, Mathf.Infinity)) {
            ...
            if (i == orderList[3]) {
                if (Physics.Raycast (tileRight, transform.TransformDirection (Vector3.down), out rightHit, Mathf.Infinity)) {
